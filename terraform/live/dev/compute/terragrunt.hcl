...
inputs = {
  ...
  # runner_pat_token is supplied at apply time via TF_VAR_runner_pat_token.
  # Never hardcode it here. In GitHub Actions, set it as a repository secret
  # and pass it as an env var: TF_VAR_runner_pat_token=${{ secrets.RUNNER_PAT }}
}
